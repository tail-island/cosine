...
from funcy import concat, func_partial, map, rcompose


def op(num_blocks, d_model, num_heads, d_ff, x_vocab_size, y_vocab_size, maximum_position, dropout_rate):
    def dense(units):
    ...
    def op(inputs):
        ...
        return tf.nn.softmax(dense(y_vocab_size)(dropout(dropout_rate)(encoder(num_blocks, d_model, num_heads, d_ff, x_vocab_size, maximum_position, dropout_rate)((x, get_padding_mask(x)))[:, 0])))
